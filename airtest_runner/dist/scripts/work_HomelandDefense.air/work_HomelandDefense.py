...
def main():
    ...
    driver.assert_template(Template(r"tpl1601348906386.png", record_pos=(0.585, 4.545), resolution=(100, 100)), "家园保卫战模块显示正常")
    #鼠标移动到作品图片上
    pic = driver.find_element_by_xpath("//*[@id='app']/div/div/div[1]/div/div/div[2]/div[1]/div[17]/div[2]/div/div/div[1]/div/div[1]/a/img")
    ActionChains(driver).move_to_element(pic).perform()
     #截图
    driver.snapshot()
    sleep(3)
    #点击作者名称或头像，进入该作者详情页
    driver.find_element_by_xpath("//*[@id='app']/div/div/div[1]/div/div/div[2]/div[1]/div[17]/div[2]/div/div/div[1]/div/div[3]/p/a").click()
    driver.assert_template(Template(r"tpl1601345185109.png", record_pos=(3.535, 4.525), resolution=(100, 100)), "点击作者名称或头像，进入该作者详情页")
    driver.assert_template(Template(r"tpl1601348817506.png", record_pos=(6.11, 3.625), resolution=(100, 100)), "点击作者名称或头像，进入该作者详情页")
    #点击作品图片，进入作品页面
